...
test_heatclient_tcserious:
	cd heat/heatclient-test && \
	time python ./test.py -t ../templates/ponytest_stack.yml -i tcserious-2014060312
...
chefclient:
	...
	cd heat/heatclient-test && \
	./test.py --template ../templates/chef_client_stack.yml --stackname chef2 --role chef-client --image tcserious-2014060312
